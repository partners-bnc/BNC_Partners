  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl w-full max-w-3xl shadow-xl border border-slate-200">
        ...
        <div className="p-6">
          <div
            className="max-h-[560px] overflow-y-auto pr-3"
            onScroll={(event) => {
          ...
          >
            <div className="text-sm text-slate-600 leading-relaxed space-y-4">
              {t('termsAgreement.sections', { returnObjects: true }).map((section) => (
                <div key={section.title} className="space-y-2">
                  <h3 className="font-poppins text-base font-semibold text-slate-900">{section.title}</h3>
