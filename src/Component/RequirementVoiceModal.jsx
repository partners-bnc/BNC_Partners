          ...
          {mode === 'voice' ? (
            <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-[#f4f8ff] via-white to-[#f9fbff] p-6">
              <div className={`flex flex-col items-center ${textAlign}`}>
                <div className={`relative h-24 w-24 rounded-full flex items-center justify-center ${
                  isListening ? 'bg-[#DC2626]/10' : 'bg-slate-100'
                }`}>
                  {isListening && (
                    <>
                      <span className="absolute h-full w-full rounded-full bg-[#DC2626]/20 animate-ping" />
                      <span className="absolute h-16 w-16 rounded-full bg-[#DC2626]/20 animate-pulse" />
                    </>
                  )}
                  <button
                    ...
                    className={`relative z-10 h-12 w-12 rounded-full flex items-center justify-center transition-all ${
                      isListening
                        ...
                        : 'bg-white text-[#DC2626] border border-slate-200 shadow'
                    }`}
              ...
              <div className="mt-5">
                ...
                <textarea
                  ...
                  className={`mt-2 w-full min-h-[120px] rounded-xl border border-slate-200 bg-white p-3 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#DC2626]/40 ${textAlign}`}
                />
                {micError && (
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6">
              ...
              <textarea
                ...
                className={`mt-2 w-full min-h-[200px] rounded-xl border border-slate-200 p-4 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#DC2626]/40 ${textAlign}`}
              />
            </div>
          )}
        </div>
        ...
        <div className={`px-6 pb-6 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between ${rowDirection}`}>
          ...
          <div className={`flex gap-2 ${rowDirection}`}>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-[#DC2626] text-white text-sm font-semibold shadow hover:bg-[#B91C1C] disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
