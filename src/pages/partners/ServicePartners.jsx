...
const ServicePartners = () => {
  ...
  const focusCardsText = t('partnerPages.service.cards', { returnObjects: true });
      ...
      <section className="relative w-full bg-[#000000] text-white -mt-16 pt-28 pb-24 min-h-[320px] overflow-hidden rounded-b-[48px]">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 pl-10 md:pl-16 relative z-10">
          <div className="max-w-3xl">
            <p className="text-xs uppercase tracking-[0.25em] text-white/70">{t('partnerPages.service.label')}</p>
            <h1 className="mt-3 text-3xl md:text-4xl font-semibold text-white">
              {t('partnerPages.service.title')}
            </h1>
            <p className="mt-3 text-white/80">
              {t('partnerPages.service.subtitle')}
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-2 text-slate-600">
                {t('partnerPages.service.sectionSubtitle')}
              </p>
            </div>
